...
def generateCSVReport(results, output_folder, output_filename):
    ...
    if(output_filename == 'ActivityCache_Activity.csv'):
        csv_out.writerow(['last_modification_time', 'expiration_time', 'last_modification_time_on_client', 'start_time', 'time_created_in_cloud', 'etag', 'activity_type', 'application', 'display_name', 'display_text', 'activity_duration_(in_seconds)', 'activity_status', 'priority', 'is_local_only', 'tag', 'group', 'clipboard_data', 'match_id', 'platform', 'description', 'content_uri', 'app_activity_id', 'parent_activity_id', 'platform_device_id', 'dds_device_id', 'clipboard_data_id', 'gdpr_type', 'package_id_hash', 'timezone', 'original_payload', 'original_clipboard_payload'])
    elif(output_filename == 'ActivityCache_ActivityOperation.csv'):
        csv_out.writerow(['created_time', 'last_modification_time', 'last_modification_time_on_client', 'expiration_time', 'operation_expiration_time', 'start_time', 'end_time', 'created_in_cloud', 'etag', 'application', 'display_text', 'app_display_name', 'activity_type', 'active_duration', 'calculated_active_duration', 'priority', 'operation_type', 'user_engaged_timezone', 'description', 'content_uri', 'id', 'tag', 'match_id', 'activation_uri_reporting_app', 'group', 'clipboard_data', 'app_activity_id', 'parent_activity_id', 'platform_device_id', 'dds_device_id', 'group_app_activity_id', 'enterprise_id', 'package_id_hash', 'original_payload', 'original_clipboard_payload'])
    elif(output_filename == 'ActivityCache_ActivityPackageID.csv'):
        csv_out.writerow(['activity_id', 'platform', 'package_name', 'expiration_time'])
    for row in results:
